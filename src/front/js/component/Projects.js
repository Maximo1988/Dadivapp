      ...
      {store.Projects_benef.length === 0 ? (
        ...
        store.Projects_benef.map((project_benef, index) => {
          ...
          return (
            ...
            >
              <CardContainer
                Name={project_benef.name}
                Date_finish={project_benef.date_finish}
                Date_start={project_benef.date_start}
                Donative_amount={project_benef.donative_amount}
                Description={project_benef.description}
                notButtonDonate={true}
              />
            </div>
          );
        })
